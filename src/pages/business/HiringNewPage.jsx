            ...
            <div className="board">
                ...
                <div className="cont mt-[40px] py-[30px] px-[45px]">
                    <div className="flex items-center pb-[20px] border-b-[1px] border-[#707070] sp:block">
                        ...
                        <input type="text" className='w-[600px] h-[50px] px-[20px] py-[5px] border-[1px] border-[#7764E4] text-[#7764E4] rounded-[5px] shadow-md sp:w-full' placeholder='ここに求人タイトル' />
                    </div>
                    ...
                    <div className="flex items-center mt-[40px] sp:block">
                        ...
                        <div className="select">
                            <select name="" id="" className='w-[182px] sp:w-full sp:mr-0'>
                ...
                <div className="flex relative max-w-[800px] mx-auto items-center justify-center sp:block">
                    <div className=" absolute left-0 text[#8898AA] sp:relative sp:text-center sp:mt-[10px]">＜戻る</div>
                    <div className="btn-gradient w-[315px] h-[64px] mt-[24px] before:w-[12px] before:h-[12px] sp:mt-[10px] sp:mx-auto">最終確認</div>
                </div>
            </div>
        </div>
    );
