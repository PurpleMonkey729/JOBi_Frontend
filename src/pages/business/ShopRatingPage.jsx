    ...
    return (
        <div className='business'>
            ...
            <div className="board">
                ...
                <div className="cont mt-[32px] py-[39px] relative">
                    ...
                    <div className='flex justify-between items-center mt-[50px] mx-[45px] pb-[10px] border-b-[1px] border-[#707070] db:block'>
                        <div className="">ワーカーからのコメント</div>
                        <div className="hidden mt-[10px] sp:block"></div>
