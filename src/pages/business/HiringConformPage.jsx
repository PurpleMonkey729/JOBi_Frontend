...
export default function BusinessHiringConformPage() {
    return (
        <div className='business businesshiringnew businesshiringconform'>
            ...
            <div className="board">
                ...
                <div className="cont mt-[40px] py-[30px] px-[45px]">
                    <div className="relative mx-auto">
                        <div className="absolute left-0 text[#8898AA]">＜ 戻って修正する</div>
                        <div className='text-center text-[#f00] font-bold'>こちらの内容で公開してよろしいですか？<br/>よろしければ下記のボタンを押して下さい。</div>
                        <div className="btn-gradient w-[315px] h-[64px] my-[24px] mx-auto">求人を公開</div>
                    </div>
                    <div className="flex items-center pb-[10px] border-b-[1px] border-[#707070]">
                        <div className="mr-[20px]">タイトル</div>
                        <input type="text" className='w-[600px] h-[50px] px-[20px] py-[5px] border-[1px] border-[#7764E4] text-[#7764E4] rounded-[5px] shadow-md' value='ここに求人タイトル' />
                    </div>
                    ...
                    <div className="flex">
                        <div className="">
                            <div className="">働く日時</div>
                            <input type="date" />
                            <br />
                            <input type="time" />
                        </div>
                        <div className="">
                            <div className="">求人の締め切り日時</div>
                            <input type="date" />
                            <br />
                            <input type="time" />
                        </div>
