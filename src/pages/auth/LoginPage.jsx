...
export default function LoginPage() {
    ...
    return (
        <div className='login w-full h-auto pt-[80px] pb-[150px]'>
            <div className="ttl w-[470px] h-[135px] mx-auto text-white text-center pt-[90px]">
                沖縄生まれ沖縄育ちのバイトマッチングサイト
                <h1 className="hidden">JOBi</h1>
            </div>
            <div className="form w-[476px] mt-[50px] mx-auto pt-[26px] px-[38px] pb-[100px] rounded-[10px] bg-[#f7fafc] shadow-md">
                ...
                <div className="relative w-[400px] h-[50px] mt-[33px] flex flex-wrap items-stretch shadow-[#bbb] shadow-md rounded-[5px]">
                ...
                <div className="relative w-[400px] h-[50px] mt-[20px] flex flex-wrap items-stretch shadow-[#bbb] shadow-md rounded-[5px]">
                    <span className="flex items-center whitespace-nowrap rounded-l px-3 py-[0.25rem] text-center">
                ...
                <p className='h-[30px] mt-[30px] flex items-center'>
                    ...
                    <label htmlFor="agree" className=''>
                        <a href="" className='text-[13px] text-[#2C92D2]'>利用規約</a>
                        <span className='text-[13px] text-[#172B4D]'>と</span>
                        <a href="" className=' text-[13px] text-[#2C92D2]'>プライバシーポリシー</a>
