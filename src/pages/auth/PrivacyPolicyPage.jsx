    ...
    return (
        <div className="regist">
            <div className="regist-header w-full max-w-[752px] pt-[50px] mx-auto sp:px-[20px]">
                ...
                <div className="text-center mt-[40px] text-[32px] text-bold bg-[#2c92d2] text-white sp:text-[25px]">プライバシーポリシー</div>
            </div>
            <div className="regist-cont">
                <div className='w-full mt-[30px] leading-[1.8] text-[16px]'>
                    株式会社MINEPRO（以下，「当社」といいます。）は，本ウェブサイト上とアプリ「JOBi」で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。<br/>
                    <br/>
                    第1条（個人情報）<br/>
                    ...
                    <br/>
                    住所：〒903-0804 沖縄県那覇市首里石嶺町３丁目９−３<br/>
                    社名：株式会社MINEPRO<br/>
                    代表取締役：伊志嶺　良太<br/>
                    Eメールアドレス：info@minepro.co.jp
                </div>
                <div className='btn-blue mt-[62px] mx-auto' onClick={login}>ログイン画面へ</div>
            </div>
        </div>
    );
}
